...
#define MEMP_NUM_TCP_PCB        16                       /* the number of simulatenously active TCP connections */

#define MEMP_NUM_TCP_PCB_LISTEN 16                        /* the number of listening TCP connections */
...
#define MEMP_NUM_NETBUF         16                        /* the number of struct netbufs */

/* Pbuf options */
#define PBUF_POOL_SIZE          20                       /* the number of buffers in the pbuf pool */
#define PBUF_POOL_BUFSIZE       500                     /* the size of each pbuf in the pbuf pool */
