...
const static GPIOConfig g_gpioConfigComm[] = {
    {GPIO_IN_GAP0, GPIO_RCU_CONFIG(GPIOE), GPIO_PIN_2, GPIO_MODE_IPU, GPIO_OSPEED_10MHZ, 0},
    {GPIO_IN_GAP1, GPIO_RCU_CONFIG(GPIOE), GPIO_PIN_3, GPIO_MODE_IPU, GPIO_OSPEED_10MHZ, 0},
    {GPIO_IN_GAP2, GPIO_RCU_CONFIG(GPIOE), GPIO_PIN_4, GPIO_MODE_IPU, GPIO_OSPEED_10MHZ, 0},

    {GPIO_I2CS0_SCL, I2CS0_SCL_GPIO_PORT, I2CS0_SCL_CLK, I2CS0_SCL_PIN, GPIO_MODE_OUT_OD, GPIO_OSPEED_10MHZ, 0},
    {GPIO_I2CS0_SDA, I2CS0_SDA_GPIO_PORT, I2CS0_SDA_CLK, I2CS0_SDA_PIN, GPIO_MODE_OUT_OD, GPIO_OSPEED_10MHZ, 0},
};
