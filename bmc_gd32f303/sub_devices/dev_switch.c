...
static const GPIOConfig g_gpioConfig_switch[] = {
    {GPIO_OUT_WX_NRST,       GPIO_RCU_CONFIG(GPIOD), GPIO_PIN_8,  GPIO_MODE_OUT_OD,       GPIO_OSPEED_10MHZ, 1},

    {GPIO_IN_P0V9_PWRGD,     GPIO_RCU_CONFIG(GPIOC), GPIO_PIN_6,  GPIO_MODE_IN_FLOATING,  GPIO_OSPEED_10MHZ, 1},//unused
    {GPIO_OUT_P0V9_EN,       GPIO_RCU_CONFIG(GPIOC), GPIO_PIN_7,  GPIO_MODE_IN_FLOATING,  GPIO_OSPEED_10MHZ, 1},//unused
    {GPIO_IN_P1V8_PWRGD,     GPIO_RCU_CONFIG(GPIOC), GPIO_PIN_8,  GPIO_MODE_IN_FLOATING,  GPIO_OSPEED_10MHZ, 1},//unused
    {GPIO_OUT_P1V8_EN,       GPIO_RCU_CONFIG(GPIOC), GPIO_PIN_9,  GPIO_MODE_IN_FLOATING,  GPIO_OSPEED_10MHZ, 1},//unused
};
