...
const static GPIOConfig g_gpioConfig_storage2[] = {
    {GPIO_CPLD_MCU_DESTORY_LED_M2B_IN,  GPIOB, GPIO_PIN_12, RCU_GPIOB, GPIO_MODE_IPU, GPIO_OSPEED_10MHZ, 0}, //M.2_B_DESTROY_LED
    {GPIO_CPLD_MCU_DESTORY_LED_M2A_IN,  GPIOB, GPIO_PIN_13, RCU_GPIOB, GPIO_MODE_IPU, GPIO_OSPEED_10MHZ, 0}, //M.2_A_DESTROY_LED
    {GPIO_CPLD_MCU_DESTORY_OUT,         GPIOB, GPIO_PIN_14, RCU_GPIOB, GPIO_MODE_OUT_PP, GPIO_OSPEED_10MHZ, 0}, //DESTROY_LED 
};
