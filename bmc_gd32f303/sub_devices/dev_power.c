...
const static GPIOConfig g_gpioConfig_power[] = {
    ...
    {GPIO_IN_P12V_PWRGD,    GPIOD, GPIO_PIN_14, RCU_GPIOD, GPIO_MODE_IN_FLOATING, GPIO_OSPEED_10MHZ, 1},//modify pin num
    {GPIO_IN_P5V_PWRGD,     GPIOC, GPIO_PIN_8,  RCU_GPIOC, GPIO_MODE_IN_FLOATING, GPIO_OSPEED_10MHZ, 1},//modify pin num
    {GPIO_IN_P3V3_PWRGD,    GPIOC, GPIO_PIN_6,  RCU_GPIOC, GPIO_MODE_IN_FLOATING, GPIO_OSPEED_10MHZ, 1},//modify pin num
};
...
static const  SensorConfig g_sensor_power[] = {
    ...
    {ADC_CHANNEL_2,         SUB_DEVICE_SDR_VBAT,       "VBAT_M"},  //modify SUB_DEVICE_SDR_VBAT 3.0V
