...
// config GPIO
const GPIOConfig_Handler g_gpioConfigHandler_storage3 = {
    .mode = SUB_DEVICE_MODE_STORAGE3,
    .gpioCfgSize = 0,
    .gpioCfg = NULL,
};

// config ADC
static const  ADCChannlesConfig g_adcChannlConfig_storage3[] = {
...
// config Sensor
static const  SensorConfig g_sensor_storage3[] = {
...
static SubDevice_Reading_T g_sensorVal_storage3[ARRARY_SIZE(g_sensor_storage3)];
const Dev_Handler g_devHandler_storage3 = {
    .mode = SUB_DEVICE_MODE_STORAGE3,
    .val = g_sensorVal_storage3,
    CREATE_CONFIG_HANDLER(adc, g_adcChannlConfig_storage3),

    CREATE_CONFIG_HANDLER(sensor, g_sensor_storage3),
