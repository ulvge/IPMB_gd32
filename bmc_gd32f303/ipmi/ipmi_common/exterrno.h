...
#define EIMGNOTSIGNED   EXTENDED_ERROR(52)      /*Not a signed image*/
#define EIMGSIGNED      EXTENDED_ERROR(53)      /*Signed image*/
#define EPREPAREFLASH   EXTENDED_ERROR(54)     /*Error Prepare Flash*/
#define EDIFFCODEBASEVER EXTENDED_ERROR(55) /* Error Different Code Base Version*/
