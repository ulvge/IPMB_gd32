	                    ...
	                    int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_SWITCH_FLASH_DEVICE,
                            ...
                            int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_ACTIVATE_FLASH_DEVICE,
                       ...
                       AMIGetFwVersionRes_T* pAMIGetFwVersionRes, int timeout )
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                         ((NETFN_AMI << 2) + 0x00), CMD_AMI_GET_FW_VERSION,
	                    ...
	                    int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_RESTORE_FLASH_DEVICE,
                                             (uint8 *)pAMIYAFUSwitchFlashDeviceReq,sizeof(AMIYAFUSwitchFlashDeviceReq_T),
                                             (uint8 *)pAMIYAFUSwitchFlashDeviceRes, &dwResLen, timeout );
    return( wRet );   
}
	                    ...
	                    int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_GET_FLASH_INFO,
			   ...
			   int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_GET_FIRMWARE_INFO,
                         ...
                         int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_GET_FMH_INFO,
	                    ...
	                    int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_GET_STATUS,
	                    ...
	                    int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_ACTIVATE_FLASH,
	                    ...
	                    int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_ALLOCATE_MEMORY,
	                    ...
	                    int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_FREE_MEMORY,
	                ...
	                int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_READ_FLASH,
	                ...
	                int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_WRITE_FLASH,
	                ...
	                int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_ERASE_FLASH,
	               ...
	               int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_PROTECT_FLASH,
	               ...
	               int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_ERASE_COPY_FLASH,
	               ...
	               int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_GET_ECF_STATUS,
	               ...
	               int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_VERIFY_FLASH,
	               ...
	               int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_GET_VERIFY_STATUS,
	                ...
	                int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_READ_MEMORY,
	               ...
	               int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_WRITE_MEMORY,
	               ...
	               int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_COPY_MEMORY,
	                ...
	                int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_COMPARE_MEMORY,
	               ...
	               int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_CLEAR_MEMORY,
	               ...
	               int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_GET_BOOT_CONFIG,
	               ...
	               int timeout,uint32 ReqLen)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_SET_BOOT_CONFIG,
	               ...
	               int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_GET_BOOT_VARS,
	               ...
	               int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_DEACTIVATE_FLASH_MODE,
	               ...
	               int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_RESET_DEVICE,
                    ...
                    int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command(pSession, PAYLOAD_TYPE_IPMI,
                                ( ( NETFN_AMI << 2 ) + 0x00 ),CMD_AMI_YAFU_DUAL_IMAGE_SUP, 
	                    ...
	                    int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_FIRMWARE_SELECT_FLASH,
	                    ...
	                    int timeout)
{
    ...
    wRet = LIBIPMI_Send_RAW_IPMI2_0_Command( pSession, PAYLOAD_TYPE_IPMI,
                                             ( ( NETFN_AMI << 2 ) + 0x00 ), CMD_AMI_YAFU_MISCELLANEOUS_INFO,
