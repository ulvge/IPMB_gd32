...
#define KVM_AUTHFAILED_RCTYPE 0x12
#define KVM_NOPERM_RCTYPE 0x13
...
LIBIPMI_API uint16 IPMICMD_AMIGetSSLCertStatus(IPMI20_SESSION_T *pSession,
						...
						int timeout);
LIBIPMI_API uint16 LIBIPMI_HL_AMIGetSSLCertStatus(IPMI20_SESSION_T *pSession,INT8U *CertExits,int timeout);
LIBIPMI_API uint16 LIBIPMI_HL_AMIGetSSLCertInfo(IPMI20_SESSION_T *pSession,char *CerInfo,int timeout);
...
LIBIPMI_API uint16 LIBIPMI_HL_AMIGetRemoteLogConf(IPMI20_SESSION_T *pSession,INT8U *Sysstatus, INT8U *Auditstatus, char *hostname,int timeout);
...
LIBIPMI_API uint16 LIBIPMI_HL_AMISetSysLogConf(IPMI20_SESSION_T *pSession, INT8U Sysenable, INT8U Auditenable, char *hostname, int timeout);
...
LIBIPMI_API uint16 LIBIPMI_HL_AMIGetRadiusConf(IPMI20_SESSION_T *pSession,IPMIRADIUSCONFIG *radius_config,int timeout);
...
LIBIPMI_API uint16 LIBIPMI_HL_AMISetRadiusConf(IPMI20_SESSION_T *pSession,IPMIRADIUSCONFIG *radius_config,int timeout);
