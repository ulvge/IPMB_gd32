...
uint16 LIBIPMI_HL_GetAllIPv6Addresses(IPMI20_SESSION_T *pSession,
				INT8U Channel, INT8U *Address, INT8U *pIPCount,
				int timeout);

uint16 LIBIPMI_HL_Get_AllIPv6Addresses(IPMI20_SESSION_T *pSession, 
				INT8U Channel, INT8U *Address, INT8U *pIPCount, 
				int timeout);
...
uint16 LIBIPMI_HL_GetIPv6LinkAddress(IPMI20_SESSION_T *pSession, 
		            INT8U *Address,INT8U Channel,
		            int timeout);
...
uint16 LIBIPMI_HL_GetIPv6LinkPrefix (IPMI20_SESSION_T *pSession, 
		            INT8U *Prefix,INT8U Channel,
		            int timeout);
...
uint16 LIBIPMI_HL_Get_IPv6Enable(IPMI20_SESSION_T *pSession, 
					INT8U *Enable,INT8U Channel,
					int timeout);
...
uint16 LIBIPMI_HL_SetIPv6NetworkCfg(IPMI20_SESSION_T *pSession,
                                        ...
                                        INT8U Channel,
                                        int timeout);
uint16 LIBIPMI_HL_SetIPv4IPv6Enable(IPMI20_SESSION_T *pSession,
					INT8U IPv4IPv6Enable,
					INT8U Channel, 
					int timeout);
...
uint16 LIBIPMI_HL_Set_IPv6Address(IPMI20_SESSION_T *pSession,
	INT8U *Address,
	INT8U Prefix,
	INT8U Channel, 
	int timeout,INT8U flag);
