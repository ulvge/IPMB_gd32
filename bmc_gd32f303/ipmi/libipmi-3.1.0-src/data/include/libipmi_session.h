...
typedef void (*pcryptfunc) (void );
typedef struct
{
    INT16U CryptofunNum;
    INT8U CryptofunName[255];
}Crypto_Init;

typedef enum
{
CRYPTO_EVP_CIPHER_CTX_INIT=0,
CRYPTO_EVP_ENCRYPTINIT_EX,
CRYPTO_EVP_CIPHER_CTX_SET_PADDING,
CRYPTO_EVP_ENCRYPTUPDATE,
CRYPTO_EVP_ENCRYPTFINAL_EX,
CRYPTO_EVP_CIPHER_CTX_CLEANUP,
CRYPTO_EVP_DECRYPTINIT_EX,
CRYPTO_EVP_DECRYPTUPDATE,
CRYPTO_EVP_DECRYPTFINAL_EX,
CRYPTO_EVP_SHA1,
CRYPTO_EVP_AES_128_CBC,
CRYPTO_HMAC,
MAX_CRYPTO_HANDLES
}Crypto_enum;
extern pcryptfunc g_CryptoHandle[MAX_CRYPTO_HANDLES];
...
LIBIPMI_API uint16 LIBIPMI_Create_IPMI_Local_Session_Ext(IPMI20_SESSION_T *pSession, char *pszUserName,
                                                   ...
                                                   INT8U *ipaddr, INT8U IPVer,INT8U *ServIPAddr,INT8U AuthFlag,int timeout);

LIBIPMI_API uint16 LIBIPMI_Create_IPMI_Local_Session_SMBMC(IPMI20_SESSION_T *pSession, char *pszUserName,
                                                   char *pszPassword, uint8 *byPrivLevel, char *xtUserName, 
                                                   INT8U *ipaddr, INT8U IPVer, INT8U AuthFlag, INT8U BMCInst,int timeout);
