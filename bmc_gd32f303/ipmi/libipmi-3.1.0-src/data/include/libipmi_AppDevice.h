...
uint16 IPMICMD_GetSysInfoParam(IPMI20_SESSION_T* pSession/*in*/, GetSystemInfoParamReq_T* pReqGetSysInfo /*in*/,						     
						     GetSystemInfoParamRes_T* pResGetSysInfo /*out*/, int timeout /*in*/);							 
...
LIBIPMI_API uint16 IPMICMD_GetChannelAccess(IPMI20_SESSION_T* pSession,
