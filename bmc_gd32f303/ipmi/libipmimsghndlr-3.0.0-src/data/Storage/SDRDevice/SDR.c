...
FullSensorRec_T   g_sensor_sdr[] =
{
    ...
    {	 /* SDR Record    0x0C   "MAC5023_PIN"   SUB_DEVICE_SDR_MAC5023_P */
		.hdr.ID               = 0x000C,
		.hdr.Version          = 0x51,
		.hdr.Type             = 0x01,
		.hdr.Len              = 0x40,
		...
		.UpperNonRecoverable  = 0xC8,   //800w  *0.25 = 200w
		.UpperCritical        = 0xB6,
		.UpperNonCritical     = 0xA5,
		.LowerNonRecoverable  = 0x00,
		.LowerCritical        = 0x00,
		.LowerNonCritical     = 0x00,
		.PositiveHysterisis   = 0x00,
		...
		.Reserved1            = 0x00,
		.Reserved2            = 0x00,
		.OEMField             = SUB_DEVICE_SDR_MAC5023_P,
		.IDStrTypeLen         = 0xC0 + sizeof("MAC5023_PIN"),
		.IDStr                = "MAC5023_PIN",
	},

	{	 /* SDR Record    0x0D   "MAC5023_VIN"  M=1,R=-1, SUB_DEVICE_SDR_MAC5023_V */
		.hdr.ID               = 0x000D,
		.hdr.Version          = 0x51,
		.hdr.Type             = 0x01,
		.hdr.Len              = 0x40,
		...
		.UpperNonRecoverable  = 0x9C,
		.UpperCritical        = 0x90,
		.UpperNonCritical     = 0x84,
		.LowerNonRecoverable  = 0x53,
		.LowerCritical        = 0x60,
		.LowerNonCritical     = 0x6C,
		.PositiveHysterisis   = 0x00,
		.NegativeHysterisis   = 0x00,
		.Reserved1            = 0x00,
		.Reserved2            = 0x00,
		.OEMField             = SUB_DEVICE_SDR_MAC5023_V,
		.IDStrTypeLen         = 0xC0 + sizeof("MAC5023_VIN"),
		.IDStr                = "MAC5023_VIN",
	},

	{	 /* SDR Record    0x0E   "MAC5023_IOUT" M=2,R=-1,  SUB_DEVICE_SDR_MAC5023_I */
		.hdr.ID               = 0x000E,
		.hdr.Version          = 0x51,
		.hdr.Type             = 0x01,
		.hdr.Len              = 0x40,
		...
		.UpperNonRecoverable  = 0xC3,
		.UpperCritical        = 0xB4,
		.UpperNonCritical     = 0xA5,
		.LowerNonRecoverable  = 0x69,
		.LowerCritical        = 0x78,
		.LowerNonCritical     = 0x87,
		.PositiveHysterisis   = 0x00,
		.NegativeHysterisis   = 0x00,
		.Reserved1            = 0x00,
		.Reserved2            = 0x00,
		.OEMField             = SUB_DEVICE_SDR_MAC5023_I,
		.IDStrTypeLen         = 0xC0 + sizeof("MAC5023_IOUT"),
		.IDStr                = "MAC5023_IOUT",
	},
