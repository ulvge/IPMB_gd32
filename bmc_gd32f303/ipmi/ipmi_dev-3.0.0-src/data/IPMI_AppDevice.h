...
#define MAX_OS_VER_NUM_LENGTH   254
...
#define OS_VERSION_NUM_PARAM  0x05
#define MAX_PARAM_SELECTOR	OS_VERSION_NUM_PARAM +1 /* Last Parameter + 1 */
...
typedef struct 
{
    INT8U    TypeOfEncoding_OSVersion;
    INT8U    StringLength_OSVersion;
    INT8U   OSVersion[MAX_OS_VER_NUM_LENGTH];
}PACKED OSVesrsion_T;
...
typedef struct {
    ...
    INT8U   SetSelector;
    INT8U   OSVersionNum[MAX_BLOCK_SIZE];

} PACKED OSVersionInfo_T;
