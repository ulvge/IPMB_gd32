...
typedef struct
{
    ...
    // INT8U get_sdr_repository_allo_info_supported:1;
	// INT8U reserve_sdr_repository_supported:1;
	// INT8U partial_add_sdr_supported:1;
	// INT8U delete_sdr_supported:1;
	// INT8U __reserved1:1;
	// INT8U modal_update_support:2;
	// INT8U overflow_flag:1;
