...
typedef struct
{
    ...
    SensorInfo_T        ME_SensorInfo [MAX_ME_SENSOR_NUMBERS + 1]; /* Holds all ME sensor informations */ /*  Seperate info of ME sensors into another array. */
 ...
 */
extern void InitPowerOnTick (void);
 ...
 */
extern void InitSysResetTick (void);
/**
 ...
 *------------------------------------------*/
extern SensorInfo_T* GetSensorInfo (INT8U SensorNum, INT8U OwnerLUN, int BMCInst);
