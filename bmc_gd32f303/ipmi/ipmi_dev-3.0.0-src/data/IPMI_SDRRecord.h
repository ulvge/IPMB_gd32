...
/**
 * @struct EntityAssocRec_T
 * @brief Entity Association Record
**/
typedef struct
{
    /* SENSOR RECORD HEADER */
    ...
    INT8U        EntityIns;
    INT8U        Flags;
    INT8U        ContainedEntityID1;
    INT8U        ContainedEntityIns1;

    /* RECORD BODY BYTES */
    INT8U        ContainedEntityID2;
    INT8U        ContainedEntityIns2;
    INT8U        ContainedEntityID3;
    INT8U        ContainedEntityIns3;
    INT8U        ContainedEntityID4;
    INT8U        ContainedEntityIns4;

} PACKED  EntityAssocRec_T;
